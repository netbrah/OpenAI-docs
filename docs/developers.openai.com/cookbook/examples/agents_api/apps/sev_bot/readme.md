...
![Incident response workflow: receive an alert, investigate evidence, request rollback approval in Slack, save incident memory, and clean up.](https://developers.openai.com/cookbook/assets/examples/agents_api/apps/sev_bot/assets/workflow.svg)
