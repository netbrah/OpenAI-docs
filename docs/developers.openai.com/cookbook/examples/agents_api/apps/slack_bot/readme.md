...
![Slack bot workflow: create or resume a thread session, search connected tools, work in a sandbox, and respond to follow-up requests.](https://developers.openai.com/cookbook/assets/examples/agents_api/apps/slack_bot/assets/workflow.svg)
